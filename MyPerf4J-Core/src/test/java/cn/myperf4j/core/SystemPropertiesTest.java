...
public class SystemPropertiesTest {
    ...
    public void testParseConfigFileDir() {
        ...
        Assertions.assertFalse(osName.startsWith("windows"));
        ...
        if (isWindowsOS) {
            ...
            Assertions.assertEquals("C:\\path\\to\\", configFilePath.substring(0, idx + 1));
        } else {
            final String configFilePath = "/path/to/MyPerf4J.properties";
            final int idx = configFilePath.lastIndexOf(File.separatorChar);
            Assertions.assertEquals("/path/to/", configFilePath.substring(0, idx + 1));
        }
    }
}
