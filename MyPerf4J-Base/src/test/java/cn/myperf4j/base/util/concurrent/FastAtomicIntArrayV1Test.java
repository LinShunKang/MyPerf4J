 ...
 */
public class FastAtomicIntArrayV1Test {

    private final FastAtomicIntArrayV1 atomicIntArray = new FastAtomicIntArrayV1(1024);
    ...
    public void testSingleThread() {
        ...
        final FastAtomicIntArrayV1 fastIntArray = new FastAtomicIntArrayV1(128 * 1024);
    ...
    private void mode1(AtomicIntegerArray intArray,
                       FastAtomicIntArrayV1 fastIntArray,
                       int x,
                       int y) {
...
//        final int testTimes = 1024 * 1024;
    ...
    private static boolean testMultiThread0(final ExecutorService executor,
        ...
        final FastAtomicIntArrayV1 fastIntArray = new FastAtomicIntArrayV1(randomKeyBound);
