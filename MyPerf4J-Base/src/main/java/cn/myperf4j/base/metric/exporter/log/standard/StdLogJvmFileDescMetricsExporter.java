...
public class StdLogJvmFileDescMetricsExporter extends AbstractLogJvmFileDescMetricsExporter {
    ...
    public void process(JvmFileDescriptorMetrics metrics, long processId, long startMillis, long stopMillis) {
        ...
        if (metricsList != null) {
            ...
            Logger.error("StdLogJvmFileDescMetricsExporter.process(" + processId + ", " + startMillis + ", " + stopMillis + "): metricsList is null!!!");
        }
    }
    ...
    public void afterProcess(long processId, long startMillis, long stopMillis) {
        ...
        if (metricsList != null) {
            ...
            Logger.error("StdLogJvmFileDescMetricsExporter.afterProcess(" + processId + ", " + startMillis + ", " + stopMillis + "): metricsList is null!!!");
        }
    }
}
