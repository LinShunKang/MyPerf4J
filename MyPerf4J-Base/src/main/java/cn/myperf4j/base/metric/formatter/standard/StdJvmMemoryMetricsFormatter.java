...
public class StdJvmMemoryMetricsFormatter implements TextMetricsFormatter<JvmMemoryMetrics> {
    ...
    private static final String TITLE_FORMAT = "MyPerf4J JVM Memory Metrics [%s, %s]%n";

    private static final String DATA_TITLE_FORMAT =
            "%-14s%21s%12s%17s%12s%19s%12s%17s%13s%19s%13s%20s%15s%22s%15s%22s%n";

    private static final String DATA_FORMAT =
            "%-14d%21.2f%12d%17.2f%12d%19.2f%12d%17.2f%13d%19.2f%13d%20.2f%15d%22.2f%15d%22.2f%n";
