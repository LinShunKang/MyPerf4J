...
public class InfluxHttpJvmBufferPoolMetricsExporter implements JvmBufferPoolMetricsExporter {
    ...
    public void process(JvmBufferPoolMetrics metrics, long processId, long startMillis, long stopMillis) {
        ...
        if (metricsList != null) {
            ...
            Logger.error("InfluxHttpJvmBufferPoolMetricsExporter.process(" + processId + ", " + startMillis + ", " + stopMillis + "): metricsList is null!!!");
        }
    }
    ...
    public void afterProcess(long processId, long startMillis, long stopMillis) {
        ...
        if (metricsList != null) {
            ...
            Logger.error("InfluxHttpJvmBufferPoolMetricsExporter.afterProcess(" + processId + ", " + startMillis + ", " + stopMillis + "): metricsList is null!!!");
        }
    }
