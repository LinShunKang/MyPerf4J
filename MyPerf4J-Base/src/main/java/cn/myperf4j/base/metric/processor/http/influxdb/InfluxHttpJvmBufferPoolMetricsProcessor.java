 ...
 */
public class InfluxHttpJvmBufferPoolMetricsProcessor implements JvmBufferPoolMetricsProcessor {
    ...
    public void process(JvmBufferPoolMetrics metrics, long processId, long startMillis, long stopMillis) {
        ...
        if (metricsList != null) {
            ...
            Logger.error("InfluxHttpJvmBufferPoolMetricsProcessor.process(" + processId + ", " + startMillis + ", " + stopMillis + "): metricsList is null!!!");
        }
    }
    ...
    public void afterProcess(long processId, long startMillis, long stopMillis) {
        ...
        if (metricsList != null) {
            ...
            Logger.error("InfluxHttpJvmBufferPoolMetricsProcessor.afterProcess(" + processId + ", " + startMillis + ", " + stopMillis + "): metricsList is null!!!");
        }
    }
