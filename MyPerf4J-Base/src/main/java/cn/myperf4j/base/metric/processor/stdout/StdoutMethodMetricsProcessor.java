 ...
 */
public class StdoutMethodMetricsProcessor implements MethodMetricsProcessor {
    ...
    public void process(MethodMetrics metrics, long processId, long startMillis, long stopMillis) {
        ...
        if (metricsList != null) {
            ...
            Logger.error("StdoutMethodMetricsProcessor.process(" + processId + ", " + startMillis + ", " + stopMillis + "): metricsList is null!!!");
        }
    }
